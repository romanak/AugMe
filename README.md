# AugMe: Multimedia augmentations library

For video augmentations, AugMe requires FFmpeg release 6.0 or higher

Install FFmpeg from official repositories:
- Windows: https://www.gyan.dev/ffmpeg/builds/ffmpeg-release-full.7z
- Ubuntu/Linux: https://johnvansickle.com/ffmpeg/releases/ffmpeg-release-amd64-static.tar.xz

> On Windows, add FFmpeg to the Path (edit environment variables)\
> On Ubuntu/Linux, install the static build: https://www.vultr.com/docs/how-to-install-the-latest-static-build-of-ffmpeg/

## Usage Examples

### Import libraries and set up parameters for augmentation
